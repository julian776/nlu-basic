...
class RecognizeText {
     ...
     */
    recognize(text, strict = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const intents = yield this.entityRepository.getAllEntities();
            if (!intents) {
            ...
            for (let entity of intents) {
                try {
                    ...
                    for (let struct of intentsStruct) {
                        const compareResult = yield this.compare(text, struct, entity.paramExamples, strict);
    ...
    compare(text, intentStruct, paramsExamples, strict = false) {
        return __awaiter(this, void 0, void 0, function* () {
